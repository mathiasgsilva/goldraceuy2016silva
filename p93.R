...
setwd(directorio)
library(foreign)
base.93<-read.dta("p93.dta",convert.factors=T)
...
base.93<-base.93[which(base.93$pe11!="si" & (base.93$pobp==2|base.93$pobp==1) & base.93$filtloc==1 & base.93$dpto<=19),c("dpto","filtloc","mes","peso2","principal","pobp","pf41a","rama","pf39","tipo_ocup","tipo_ocup_todos","pe2","pe3","horas_1","pe11","edu","nivel2","finalizo")]
