...
setwd(directorio)
library(foreign)
base.92<-read.dta("p92.dta",convert.factors=T)
...
base.92<-base.92[which(base.92$pe11!=1 & (base.92$pobp==2|base.92$pobp==1) & base.92$filtloc==1 & base.92$dpto<=19),c("dpto","filtloc","mes","peso2","principal_sf","pobp","pf41a","rama","pf39","tipo_ocup","tipo_ocup_todos","pe2","pe3","horas_1","pe11","edu","nivel2","finalizo")]
