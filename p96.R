...
setwd(directorio)
library(foreign)
base.96<-read.dta("p96.dta",convert.factors=T)
...
base.96<-base.96[which(base.96$pe11!=1 & (base.96$pobp==2|base.96$pobp==1) & base.96$filtloc==1),c("dpto","filtloc","mes","peso2","principal","pobp","pf41a","rama","pf39","tipo_ocup","tipo_ocup_todos","pe2","pe3","horas_1","pe11","edu","nivel2","finalizo")]
