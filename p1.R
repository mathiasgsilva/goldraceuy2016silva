...
setwd(directorio)
library(foreign)
base.01<-read.dta("p1.dta",convert.factors=T)
...
base.01<-base.01[which(base.01$pe11!=1 & (base.01$pobp==2|base.01$pobp==1) & base.01$filtloc==1),c("dpto","filtloc","mes","peso2","principal","pobp","pf41a","rama","pf39","tipo_ocup","tipo_ocup_todos","pe2","pe3","horas_1","pe11","edu","nivel2","finalizo")]
