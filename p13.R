...
setwd(directorio)
library(foreign)
base.13<-read.dta("p13.dta",convert.factors=T)
...
base.13<-base.13[which(base.13$pe11!=1 & base.13$pobpcoac=="ocupados " & base.13$filtloc==1),c("dpto","filtloc","mes","pesoano","principal_sf","pobpcoac","pf41a","rama","pf39","pe2","pe3","horas_1","pe11","edu","nivel2","e197_1")]
