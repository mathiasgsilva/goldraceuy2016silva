...
setwd(directorio)
library(foreign)
base.03<-read.dta("p3.dta",convert.factors=T)
...
base.03<-base.03[which(base.03$pe11!=1 & (base.03$pobp==2|base.03$pobp==1) & base.03$filtloc==1),c("dpto","filtloc","mes","peso2","principal","pobp","pf41a","rama","pf39","tipo_ocup","tipo_ocup_todos","pe2","pe3","horas_1","pe11","edu","nivel2","finalizo")]