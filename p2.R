...
setwd(directorio)
library(foreign)
base.02<-read.dta("p2.dta",convert.factors=T)
...
base.02<-base.02[which(base.02$pe11!=1 & (base.02$pobp==2|base.02$pobp==1) & base.02$filtloc==1),c("dpto","filtloc","mes","peso2","principal","pobp","pf41a","rama","pf39","tipo_ocup","tipo_ocup_todos","pe2","pe3","horas_1","pe11","edu","nivel2","finalizo")]
