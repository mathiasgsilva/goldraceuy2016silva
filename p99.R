...
setwd(directorio)
library(foreign)
base.99<-read.dta("p99.dta",convert.factors=T)
...
base.99<-base.99[which(base.99$pe11!=1 & (base.99$pobp==2|base.99$pobp==1) & base.99$filtloc==1),c("dpto","filtloc","mes","peso2","principal","pobp","pf41a","rama","pf39","tipo_ocup","tipo_ocup_todos","pe2","pe3","horas_1","pe11","edu","nivel2","finalizo")]
