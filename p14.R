...
setwd(directorio)
library(foreign)
base.14<-read.dta("p14.dta",convert.factors=T)
...
base.14<-base.14[which(base.14$pe11!=1 & base.14$pobpcoac=="ocupados " & base.14$filtloc==1),c("dpto","filtloc","mes","pesoano","principal_sf","pobpcoac","pf41a","rama","pf39","pe2","pe3","horas_1","pe11","edu","nivel2","e197_1")]
