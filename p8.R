...
setwd(directorio)
library(foreign)
base.08<-read.dta("p8.dta",convert.factors=T)
...
base.08<-base.08[which(base.08$pe11!=1 & base.08$pobpcoac==" ocupados " & base.08$filtloc==1),c("dpto","filtloc","mes","pesoano","principal_sf","pobpcoac","pf41a","rama","pf39","tipo_ocup","pe2","pe3","horas_1","pe11","edu","nivel2","finalizo")]
