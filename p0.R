...
setwd(directorio)
library(foreign)
base.00<-read.dta("p0.dta",convert.factors=T)
...
base.00<-base.00[which(base.00$pe11!=1 & (base.00$pobp==2|base.00$pobp==1) & base.00$filtloc==1),c("dpto","filtloc","mes","peso2","principal","pobp","pf41a","rama","pf39","tipo_ocup","tipo_ocup_todos","pe2","pe3","horas_1","pe11","edu","nivel2","finalizo")]
