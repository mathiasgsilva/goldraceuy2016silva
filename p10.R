...
setwd(directorio)
library(foreign)
base.10<-read.dta("p10.dta",convert.factors=T)
...
base.10<-base.10[which(base.10$pe11!=1 & base.10$pobpcoac==" ocupados " & base.10$filtloc==1),c("dpto","filtloc","mes","pesoano","principal_sf","pobpcoac","pf41a","rama","pf39","pe2","pe3","horas_1","pe11","edu","nivel2","finalizo")]
