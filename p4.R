...
setwd(directorio)
library(foreign)
base.04<-read.dta("p4.dta",convert.factors=T)
...
base.04<-base.04[which(base.04$pe11!=1 & (base.04$pobp==2|base.04$pobp==1) & base.04$filtloc==1),c("dpto","filtloc","mes","peso2","principal","pobp","pf41a","rama","pf39","tipo_ocup","pe2","pe3","horas_1","pe11","edu","nivel2","finalizo")]
