...
setwd(directorio)
library(foreign)
base.98<-read.dta("p98.dta",convert.factors=T)
...
base.98<-base.98[which(base.98$pe11!=1 & (base.98$pobp==2|base.98$pobp==1) & base.98$filtloc==1),c("dpto","filtloc","mes","peso2","principal","pobp","pf41a","rama","pf39","tipo_ocup","tipo_ocup_todos","pe2","pe3","horas_1","pe11","edu","nivel2","finalizo")]
