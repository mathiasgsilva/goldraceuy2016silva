...
setwd(directorio)
library(foreign)
base.94<-read.dta("p94.dta",convert.factors=T)
...
base.94<-base.94[which(base.94$pe11!=1 & (base.94$pobp==2|base.94$pobp==1) & base.94$filtloc==1),c("dpto","filtloc","mes","peso2","principal","pobp","pf41a","rama","pf39","tipo_ocup","tipo_ocup_todos","pe2","pe3","horas_1","pe11","edu","nivel2","finalizo")]
