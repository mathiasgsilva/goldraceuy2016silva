...
setwd(directorio)
library(foreign)
base.12<-read.dta("p12.dta",convert.factors=T)
...
base.12<-base.12[which(base.12$pe11!=1 & base.12$pobpcoac=="ocupados" & base.12$filtloc==1),c("dpto","filtloc","mes","pesoano","principal_sf","pobpcoac","pf41a","rama","pf39","tipo_ocup","pe2","pe3","horas_1","pe11","edu","nivel2","e197_1")]
