...
setwd(directorio)
library(foreign)
base.05<-read.dta("p5.dta",convert.factors=T)
...
base.05<-base.05[which(base.05$pe11!=1 & (base.05$pobp==2|base.05$pobp==1) & base.05$filtloc==1),c("dpto","filtloc","mes","peso2","principal","pobp","pf41a","rama","pf39","tipo_ocup","pe2","pe3","horas_1","pe11","edu","nivel2","finalizo")]
