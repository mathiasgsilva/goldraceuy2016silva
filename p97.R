...
setwd(directorio)
library(foreign)
base.97<-read.dta("p97.dta",convert.factors=T)
...
base.97<-base.97[which(base.97$pe11!=1 & (base.97$pobp==2|base.97$pobp==1) & base.97$filtloc==1),c("dpto","filtloc","mes","peso2","principal","pobp","pf41a","rama","pf39","tipo_ocup","tipo_ocup_todos","pe2","pe3","horas_1","pe11","edu","nivel2","finalizo")]
