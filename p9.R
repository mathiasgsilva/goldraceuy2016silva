...
setwd(directorio)
library(foreign)
base.09<-read.dta("p9.dta",convert.factors=T)
...
base.09<-base.09[which(base.09$pe11!=1 & base.09$pobpcoac==" ocupados " & base.09$filtloc==1),c("dpto","filtloc","mes","pesoano","principal_sf","pobpcoac","pf41a","rama","pf39","tipo_ocup","pe2","pe3","horas_1","pe11","edu","nivel2","finalizo")]
